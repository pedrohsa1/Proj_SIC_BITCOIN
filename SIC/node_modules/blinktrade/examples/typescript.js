...
var blinktrade_1 = require("blinktrade");
var blinktrade = new blinktrade_1.BlinkTradeWS();
blinktrade.connect().then(function () {
    ...
    return blinktrade.subscribeOrderbook(['BTCUSD'])
        .on('OB:NEW_ORDER', function (data) {
        console.log('OB:NEW_ORDER', data);
    }).on('OB:UPDATE_ORDER', function (data) {
        console.log('OB:UPDATE_ORDER', data);
    }).on('OB:DELETE_ORDER', function (data) {
        console.log('OB:DELETE_ORDER', data);
    }).on('OB:DELETE_ORDERS_THRU', function (data) {
        console.log('OB:DELETE_ORDERS_THRU', data);
    }).on('OB:TRADE_NEW', function (data) {
